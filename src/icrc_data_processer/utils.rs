...
pub fn top_x_by_txvalue(mut transactions: Vec<ProcessedTX>, result_length: usize) -> Vec<ProcessedTX> {
    // decending
...
pub fn top_x_txcount(mut transactions: Vec<(String, u64)>, result_length: usize) -> Vec<(String, u64)> {
    // decending
