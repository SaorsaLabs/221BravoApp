export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'set_target_canister' : IDL.Func([IDL.Text, IDL.Text], [IDL.Text], []),
    'stop_all_timers' : IDL.Func([], [IDL.Text], []),
    'test_Small_tx_2' : IDL.Func([], [IDL.Text], []),
    'test_call_1' : IDL.Func([], [IDL.Text], []),
    'test_call_1A' : IDL.Func([IDL.Text], [IDL.Text], []),
    'test_get_alldata' : IDL.Func([IDL.Nat32], [IDL.Text], ['query']),
    'test_index_stx_3' : IDL.Func([], [IDL.Text], []),
    'test_send_tx' : IDL.Func([], [IDL.Text], []),
  });
};
