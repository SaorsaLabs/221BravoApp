export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'get_principal_balance' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    ...
    'set_stats_return_length' : IDL.Func([IDL.Nat64], [IDL.Text], []),
    'set_stats_timescales' : IDL.Func([IDL.Nat64, IDL.Nat64], [IDL.Text], []),
