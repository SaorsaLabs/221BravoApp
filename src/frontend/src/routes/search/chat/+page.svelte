...
<svelte:head>
	...
	<meta name="description" content="Search Chat Transactions" />
</svelte:head>

<LayoutCombine>
	<span slot="head">
		<Head/>
		<SearchSubHead selected="4" on:click={handleSubHeadClick}/>
	</span>
	...
	<span slot="body">
		...
		{#if hideAccountSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Chat Account Search</h4></td>
						<td class="rText"><img class="headAlign" src={chatLogo} alt="Chat Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
		...
		{#if hideBlockSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Chat Block Search</h4></td>
						<td class="rText"><img class="headAlign" src={chatLogo} alt="ckBTC Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
