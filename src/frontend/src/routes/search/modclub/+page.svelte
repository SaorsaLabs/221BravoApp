...
<svelte:head>
	<title>ModClub Search</title>
	<meta name="description" content="Search ModClub Transactions" />
</svelte:head>

<LayoutCombine>
	<span slot="head">
		<Head/>
		<SearchSubHead selected="8" on:click={handleSubHeadClick}/>
	</span>
	...
	<span slot="body">
		...
		{#if hideAccountSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">ModClub Account Search</h4></td>
						<td class="rText"><img class="headAlign" src={projectLogo} alt="ModClub Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
		...
		{#if hideBlockSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Modclub Block Search</h4></td>
						<td class="rText"><img class="headAlign" src={projectLogo} alt="ModClub Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
