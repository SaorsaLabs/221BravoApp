...
<svelte:head>
	<title>Hot Token Search</title>
	<meta name="description" content="Hot Token Transactions" />
</svelte:head>

<LayoutCombine>
	<span slot="head">
		<Head/>
		<SearchSubHead selected="6" on:click={handleSubHeadClick}/>
	</span>
	...
	<span slot="body">
		...
		{#if hideAccountSearch == false}		
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Hot Token Account Search</h4></td>
						<td class="rText"><img class="headAlign" src={hotLogo} alt="ckBTC Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
		...
		{#if hideBlockSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Hot Token Block Search</h4></td>
						<td class="rText"><img class="headAlign" src={hotLogo} alt="ckBTC Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
