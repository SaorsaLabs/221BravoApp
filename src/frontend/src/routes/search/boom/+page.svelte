...
<svelte:head>
	...
	<meta name="description" content="Search BoomDAO Transactions" />
</svelte:head>

<LayoutCombine>
	<span slot="head">
		<Head/>
		<SearchSubHead selected="10" on:click={handleSubHeadClick}/>
	</span>
	...
	<span slot="body">
		...
		{#if hideAccountSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">BoomDAO Account Search</h4></td>
		...
		{#if hideBlockSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">BoomDao Block Search</h4></td>
						<td class="rText"><img class="headAlign" src={projectLogo} alt="Project Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
