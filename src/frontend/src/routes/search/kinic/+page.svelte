...
<svelte:head>
	<title>Kinic Search</title>
	<meta name="description" content="Search Kinic Transactions" />
</svelte:head>

<LayoutCombine>
	<span slot="head">
		<Head/>
		<SearchSubHead selected="5" on:click={handleSubHeadClick}/>
	</span>
	...
	<span slot="body">
		...
		{#if hideAccountSearch == false}		
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Kinic Account Search</h4></td>
						<td class="rText"><img class="headAlign" src={kinicLogo} alt="ckBTC Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
		...
		{#if hideBlockSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Kinic Block Search</h4></td>
						<td class="rText"><img class="headAlign" src={kinicLogo} alt="ckBTC Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
