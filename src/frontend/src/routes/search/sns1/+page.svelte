...
<svelte:head>
	<title>SNS-Dragginz Search</title>
	<meta name="description" content="Search SNS-1 Transactions" />
</svelte:head>

<LayoutCombine>
	<span slot="head">
		<Head/>
		<SearchSubHead selected="3" on:click={handleSubHeadClick}/>
	</span>
	...
	<span slot="body">
		...
		{#if hideAccountSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Dragginz (SNS-1) Account Search</h4></td>
						<td class="rText"><img class="headAlign" src={sns1Logo} alt="SNS-1 Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
		...
		{#if hideBlockSearch == false}
			<ContentBox type="standard-shaddow-dark">
				<table style="width: 100%;">
					<tr>
						<td><h4 class="headAlign">Dragginz (SNS-1) Block Search</h4></td>
						<td class="rText"><img class="headAlign" src={sns1Logo} alt="SNS-1 Logo" width="50px"/> </td>
					</tr>
				</table>
				{#key resetKey}
