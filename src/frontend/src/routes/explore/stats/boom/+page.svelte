<script>
	...
	import projectLogo from '$lib/images/projectLogos/BoomLogo.png';
	...
	import { BOOM_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = BOOM_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "BOOM";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/boomdaosns"},
		{platform: "dscvr", url: "https://dscvr.one/p/boomdaosns"},
	];
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/xjngq-yaaaa-aaaaq-aabha-cai";
	let whitepaperURL = "https://u52bf-3qaaa-aaaal-qb5wq-cai.icp0.io/";
	let githubURL = "";
	let teamWebsite = "https://u52bf-3qaaa-aaaal-qb5wq-cai.icp0.io/";
	let marketplace = "";
	let marketplace2 = "";
	let marketplace3 = "";
					...
					<tr>
						...
						<td class="box" style="width: 100%">
							<HeadCards 
								token={token} 
								tradePair={"BOOM/ICP"} 
								searchURL={"/search/boom"} 
								tradeURL={"https://iclight.io/ICDex/BOOM/ICP"}
								is_icrc={true}
								quoteCurrency={"icp"}
							/>
						</td>
		...
		{#if LS == true || LS == "true"} 
			<ContentBox type={"standard-shaddow-black"} style="">
				...
				{:then}
					...
					<DailyActive token={"BOOM"} is_icrc={true}/>
				{/await}
			</ContentBox>
		{/if}
