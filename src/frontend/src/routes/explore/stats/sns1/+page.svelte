<script>
	...
	import { SNS1_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = SNS1_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "SNS1";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/SNS1dao"},
		{platform: "dscvr", url: "https://dscvr.one/p/dragginz"},
	];
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/zxeu2-7aaaa-aaaaq-aaafa-cai";
	let whitepaperURL = "https://yegk3-bqaaa-aaaae-aajza-cai.icp0.io/#plan";
	let githubURL = "";
	let teamWebsite = "https://yegk3-bqaaa-aaaae-aajza-cai.icp0.io/";
	let marketplace = "https://app.sonic.ooo/swap";
	let marketplace2 = "https://iclight.io/ICDex/SNS1/ICP";
		...
		<ContentBox type="standard-shaddow-black">
			<div style="padding: 10px;">
				<table style="width: 100%">
					<tr>
						<td style="width: 70px;">
							<img class="headAlign" src={sns1Logo} alt="Dragginz Logo" width="50px"/>
						</td>
						<td >
							<p class="tokenTextHead">Dragginz</p>
						</td>
						<td class="box" style="width: 100%">
							<HeadCards 
								token={token} 
								tradePair={"SNS1/ICP"} 
								searchURL={"/search/sns1"} 
								tradeURL={"https://iclight.io/ICDex/SNS1/ICP"}
								is_icrc={true}
								quoteCurrency={"icp"}
							/>
						</td>
