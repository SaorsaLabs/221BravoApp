<script>
	...
	import { CHAT_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = CHAT_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "CHAT";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/OpenChat"},
		{platform: "openchat", url: "https://oc.app/community/dgegb-daaaa-aaaar-arlhq-cai"},
		{platform: "dscvr", url: "https://dscvr.one/p/openchat"},
	];
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/3e3x2-xyaaa-aaaaq-aaalq-cai";
	let whitepaperURL = "https://oc.app/whitepaper";
	let githubURL = "https://github.com/open-chat-labs/open-chat";
	let teamWebsite = "https://oc.app/features";
	let marketplace = "https://app.sonic.ooo/swap";
	let marketplace2 = "https://iclight.io/ICDex/CHAT/ICP";
		...
		<ContentBox type="standard-shaddow-black">
			<div style="padding: 10px;">
				<table style="width: 100%">
					<tr>
						<td style="width: 70px;">
							<img class="headAlign" src={chatLogo} alt="Chat Logo" width="50px"/>
						</td>
						<td >
						...
						<td class="box" style="width: 100%">
							<HeadCards 
								token={token} 
								tradePair={"CHAT/ICP"} 
								searchURL={"/search/chat"} 
								tradeURL={"https://iclight.io/ICDex/CHAT/ICP"}
								is_icrc={true}
								quoteCurrency={"icp"}
							/>
						</td>
