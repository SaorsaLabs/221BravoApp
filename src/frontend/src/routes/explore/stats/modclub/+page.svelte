<script>
	...
	import projectLogo from '$lib/images/projectLogos/ModClub.png';
	...
	import { ModClub_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = ModClub_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "MODCLUB";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/ModclubApp"},
		{platform: "dscvr", url: "https://dscvr.one/p/modclub"},
		{platform: "distrikt", url: "https://distrikt.app/u/MODCLUB_Official"}
	];
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/w7g63-nqaaa-aaaaq-aabca-cai";
	let whitepaperURL = "https://docsend.com/view/kuxk6x5pghemyrje";
	let githubURL = "https://github.com/modclub-app";
	let teamWebsite = "https://modclub.ai/";
	let marketplace = "https://app.sonic.ooo/swap";
	let marketplace2 = "https://iclight.io/ICDex/MOD/ICP";
		...
		{#if LS == true || LS == "true"} 
			<ContentBox type={"standard-shaddow-black"} style="">
				...
				{:then}
					...
					<DailyActive token={"Modclub"} is_icrc={true}/>
				{/await}
			</ContentBox>
		{/if}
