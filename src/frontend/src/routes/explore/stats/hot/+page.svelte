<script>
	...
	import tokenLogo from '$lib/images/hotOrNot.png';
	...
	import { HOT_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = HOT_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "HOT";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/hotornot_dapp"},
		{platform: "dscvr", url: "https://dscvr.one/p/hot-or-not"},
		{platform: "distrikt", url: "https://distrikt.app/u/GoBazzinga"},
		{platform: "openchat", url: "https://oc.app/group/qpj6u-uyaaa-aaaar-aq6mq-cai"},
		
	]; 
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/67bll-riaaa-aaaaq-aaauq-cai";
	let whitepaperURL = "https://hotornot.notion.site/Hot-or-Not-Whitepaper-c539179e51f44867979f4372e4635f59";
	let githubURL = "https://github.com/go-bazzinga/hot-or-not-dapp";
	let teamWebsite = "https://hotornot.wtf/";
	let marketplace = "https://app.sonic.ooo/swap";
	let marketplace2 = "https://iclight.io/ICDex/HOT/ICP";
		...
		<ContentBox type="standard-shaddow-black">
			<div style="padding: 10px;">
				<table style="width: 100%">
					<tr>
						<td style="width: 70px;">
							<img class="headAlign" src={tokenLogo} alt="Hot Logo" width="50px"/>
						</td>
						<td >
						...
						<td class="box" style="width: 100%">
							<HeadCards 
								token={token} 
								tradePair={"HOT/ICP"} 
								searchURL={"/search/hot"} 
								tradeURL={"https://iclight.io/ICDex/HOT/ICP"}
								is_icrc={true}
								quoteCurrency={"icp"}
							/>
						</td>
