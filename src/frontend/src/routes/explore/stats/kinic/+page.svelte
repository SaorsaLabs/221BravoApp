<script>
	...
	import tokenLogo from '$lib/images/kinic.png';
	...
	import { KINIC_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = KINIC_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "KINIC";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/kinic_app"},
		{platform: "openchat", url: "https://oc.app/group/tz3gc-eyaaa-aaaaf-ahgeq-cai"},
		{platform: "dscvr", url: "https://dscvr.one/p/kinicdao"},
	];
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/7jkta-eyaaa-aaaaq-aaarq-cai";
	let whitepaperURL = "https://74iy7-xqaaa-aaaaf-qagra-cai.raw.ic0.app/whitepaper";
	let githubURL = "";
	let teamWebsite = "https://kinic.io";
	let marketplace = "https://app.sonic.ooo/swap";
	let marketplace2 = "https://iclight.io/ICDex/KINIC/ICP";
		...
		<ContentBox type="standard-shaddow-black">
			<div style="padding: 10px;">
				<table style="width: 100%">
					<tr>
						<td style="width: 70px;">
							<img class="headAlign" src={tokenLogo} alt="Kinic Logo" width="50px"/>
						</td>
						<td >
						...
						<td class="box" style="width: 100%">
							<HeadCards 
								token={token} 
								tradePair={"KINIC/ICP"} 
								searchURL={"/search/kinic"} 
								tradeURL={"https://iclight.io/ICDex/KINIC/ICP"}
								is_icrc={true}
								quoteCurrency={"icp"}
							/>
						</td>
