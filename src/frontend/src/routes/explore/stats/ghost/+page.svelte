<script>
	...
	import tokenLogo from '$lib/images/ghost_logo.png';
	...
	import { GHOST_decimals } from "../../../../lib/code/constants";
	...
	let decimals  = GHOST_decimals;
    let vPower = 1/Math.pow(10, decimals);
	let token = "GHOST";

	let socials = [
		{platform: "twitter", url: "https://twitter.com/ghost_icp"},
		{platform: "dscvr", url: "https://dscvr.one/p/ghost"}
	];
	let canisterDashboard = "https://dashboard.internetcomputer.org/sns/4m6il-zqaaa-aaaaq-aaa2a-cai";
	let whitepaperURL = "";
	let githubURL = "";
	let teamWebsite = "https://www.icghost.org/";
	let marketplace = "https://app.sonic.ooo/swap";
	let marketplace2 = "https://iclight.io/ICDex/GHOST/ICP";
		...
		<ContentBox type="standard-shaddow-black">
			<div style="padding: 10px;">
				<table style="width: 100%">
					<tr>
						<td style="width: 70px;">
							<img class="headAlign" src={tokenLogo} alt="Ghost Logo" width="50px"/>
						</td>
						<td >
						...
						<td class="box" style="width: 100%">
							<HeadCards 
								token={token} 
								tradePair={"GHOST/ICP"} 
								searchURL={"/search/ghost"} 
								tradeURL={"https://iclight.io/ICDex/GHOST/ICP"}
								is_icrc={true}
								quoteCurrency={"icp"}
							/>
						</td>
