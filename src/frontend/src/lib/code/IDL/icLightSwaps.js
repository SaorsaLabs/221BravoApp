export const swapsIDL = ({ IDL }) => {
	...
	const CallType = IDL.Variant({
		...
		DRC20: IDL.Variant({
			...
			approve: IDL.Tuple(Spender, Amount__2, IDL.Opt(Nonce__3), IDL.Opt(Sa__1), IDL.Opt(Data__2)),
			...
			transfer: IDL.Tuple(To, Amount__2, IDL.Opt(Nonce__3), IDL.Opt(Sa__1), IDL.Opt(Data__2)),
		...
		ICTokens: IDL.Variant({
			burn: IDL.Tuple(Amount__2, IDL.Opt(Nonce__3), IDL.Opt(Sa__1), IDL.Opt(Data__2)),
			mint: IDL.Tuple(Address__1, Amount__2, IDL.Opt(Nonce__3), IDL.Opt(Data__2))
		}),
		__skip: IDL.Null
	});
	...
	const BackupResponse = IDL.Variant({
		...
		traderReferrerTemps: IDL.Vec(IDL.Tuple(AccountId__2, IDL.Tuple(AccountId__2, IDL.Text, Time))),
	...
	return IDL.Service({
		...
		comp_result: IDL.Func([IDL.Opt(IDL.Nat), Address], [IDL.Opt(CompResult__1)], ['query']),
		...
		comp_round: IDL.Func([IDL.Opt(IDL.Nat)], [IDL.Nat, IDL.Opt(RoundItem__1)], ['query']),
