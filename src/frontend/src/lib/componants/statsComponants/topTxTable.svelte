<script>
    ...
    else popupType = 'noPrincipalBlock';
    ...
    const dataNames = [ 'block', 'date', 'time', 'fromPshort', 'toPshort', 'fromAshort', 'toAshort',
	...
	const sortByNumber = (colHeaderInput) => {
        ...
        else if (colHeaderInput == tableHeaders[3])  dataNM = dataNames[7];
        else if (colHeaderInput == tableHeaders[4]) dataNM = dataNames[11];
