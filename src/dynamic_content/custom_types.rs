...
pub struct ProjectCollection {
    pub bucket1: Vec<ProjectCard>,
    pub bucket2: Vec<ProjectCard>,
    pub bucket3: Vec<ProjectCard>,
    pub bucket4: Vec<ProjectCard>,
    pub bucket5: Vec<ProjectCard>,
    pub bucket6: Vec<ProjectCard>,
    pub bucket7: Vec<ProjectCard>,
    pub bucket8: Vec<ProjectCard>,
}